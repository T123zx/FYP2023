              ...
              children: [
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Employee\'s Contact Number',
                            labelStyle: FlutterFlowTheme.of(context)
                                .titleLarge
                                .override(
                                  fontFamily: 'Poppins',
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          obscureText: false,
                          decoration: InputDecoration(
                            labelText: 'Employee\'s Preferences',
                            labelStyle: FlutterFlowTheme.of(context)
                                .titleLarge
                                .override(
                                  fontFamily: 'Poppins',
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await BirthdayListRecord.collection
                            .doc()
                            .set(createBirthdayListRecordData(
                              employeeName: _model.textController1.text,
                              employeeBirthday: _model.datePicked,
                              contactNo: _model.textController2.text,
                              preferences: _model.textController3.text,
                            ));
